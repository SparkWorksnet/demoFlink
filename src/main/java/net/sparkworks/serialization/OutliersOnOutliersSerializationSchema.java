...
public class OutliersOnOutliersSerializationSchema implements SerializationSchema<OutliersResult> {

    public byte[] serialize(final OutliersResult element) {

        ObjectMapper mapper = new ObjectMapper();
        SimpleModule module = new SimpleModule();
        module.addSerializer(OutliersResult.class, new OutliersOnOutliersSerializer());
